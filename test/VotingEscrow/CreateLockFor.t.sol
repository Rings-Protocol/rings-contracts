...
contract CreateLockFor is VotingEscrowTest {
  ...
  uint internal constant WEEK = 7 * 86400;
    ...
    function testFuzz_createLockFor_simple(address pranker, address recipient, uint256 amount, uint256 duration) public {
    ...
    function testFuzz_createLockFor_TooLongDuration(address pranker, address recipient, uint256 amount, uint256 duration) public {
      vm.assume(pranker != address(0));
      amount = bound(amount, 1, 10e25);
